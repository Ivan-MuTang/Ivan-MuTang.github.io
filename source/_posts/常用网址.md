...
## 安装CURL
[Windows安装curl](https://blog.csdn.net/qq_37958578/article/details/79973265)

**安装：**
1：进入[curl官网](https://curl.haxx.se/download.html)下载合适的版本，我这里下载的是Windows 64位的curl.

2:解压下载的curl

3:可以给Windows增加curl命令的环境变量，增加CURL_HOME环境变量，给PATH环境变量加上%CURL_HOME%;

![image.png](https://tc.jisicn.top/img/20251231170138947.png)
