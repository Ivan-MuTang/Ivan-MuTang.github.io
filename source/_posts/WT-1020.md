...
### 二、检测要求
#### 共5个相机，CCD1、CCD2分别测180度外针内排与外排的长短，高低PIN，缺针，针宽度
#### * 180度内针长短
#### * 180度内针高低PIN
#### * 180度内针 针宽度
...
### 三、打光效果
#### CCD1：180度直针内排  针长短、高低PIN、针宽度
![image.png](https://tc.jisicn.top/img/20260418074501050.png)

![image.png](https://tc.jisicn.top/img/20260418074607497.png)

安装尺寸
![image.png](https://tc.jisicn.top/img/20260418075820482.png)

<div STYLE="page-break-after: always;"></div> <!-- 分页 -->

#### CCD2：180度直针内排 针长短、高低PIN、针宽度
![image.png](https://tc.jisicn.top/img/20260418074932087.png)

安装尺寸
![image.png](https://tc.jisicn.top/img/20260418075744987.png)
